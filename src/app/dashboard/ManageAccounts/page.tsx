...
// {
//     "profile_id": "6640d3c1a9dd5450272589fd",
//     "headline": "This is a headline",
//     "bio": "This is bio 22eee remove populate",
//     "about": "I have 4 years of experience",
...
//     "price": 5000,
//     "time_slots": "", 
//     "comments": "Best chef ever",
//     "rating": 4,
//     "profilephoto": "https://example.com/profilephoto.jpg",
//     "coverphoto": "https://example.com/coverphoto.jpg",
//     "top_cuisine": ["https://example.com/cuisine1.jpg", "https://example.com/cuisine2.jpg"]
// }
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="mt-2">
                                    <textarea
                                        ...
                                        onChange={handleChangetext}
                                        className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                        defaultValue={`Are you in search of a skilled and passionate chef in Edmonton, Alberta? Look no further! I'm Vinay, a professional chef with a flair for creating exquisite cuisines that tantalize the taste buds. With years of experience in the culinary industry, I have honed my skills to deliver top-notch dishes that cater to a variety of tastes and dietary preferences.

                                        As a chef, I prioritize using fresh, locally-sourced ingredients to ensure the highest quality and flavor in every dish. My diverse culinary background allows me to craft menus that feature a wide range of cuisines, from traditional comfort foods to gourmet delights. Whether you're hosting an intimate gathering or a large event, I have the expertise to curate a memorable dining experience for you and your guests.
                                        
                                        My services are affordably priced at $50.0 daily, making it easy to elevate your dining experience without breaking the bank. If you're ready to elevate your next event with delectable dishes and impeccable service, feel free to message me to discuss how we can collaborate to create a truly unforgettable culinary experience. Let's bring your culinary vision to life!`}
                                ...
                                <div className="col-span-full">
                                    ...
                                    <div className="mt-2">
                                        <textarea
                                            ...
                                            rows={3}
                                            className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            defaultValue={'My services are affordably priced at $50.0 daily, making it easy to elevate your dining experience without breaking the bank. If youre ready to elevate your next event with delectable dishes and impeccable service, feel free to message me to discuss how we can collaborate to create a truly unforgettable culinary experience. Let bring your culinary vision to life!'}
                                        />
                                    </div>
