  ...
  return (
    <>
      <div className="border-b border-gray-900/10 pb-12">
        <h2 className="text-2xl  font-semibold leading-7 text-gray-900 flex justify-center">
          Profile Details
        </h2>
        <div className="col-span-full">
          ...
          <div className="mt-2">
            <textarea
              ...
              defaultValue={
                "Passionate Edmonton Chef Serving Up Delicious and Affordable Daily Menus."
              }
            />
          </div>
        </div>
        ...
        <div className="col-span-full mt-4">
          ...
          <p className="mt-3 text-sm leading-6 text-gray-600">
            Describe what you do and why you are the best.
          </p>
          <div className="mt-2">
            <textarea
              name="about"
              ...
              return (
                <div key={index} className="flex gap-1 ml-3">
                  <div className="mt-1">
                    <input
                      type="checkbox"
                      // Corrected to "afternoon" to match key in formData
                      name="afternoon"
                      onChange={handleCheckboxChange}
                      id={`afternoon-${index}`}
                      value={item.time}
        ...
        <div>
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-2">
                <select
                  // Added an ID for accessibility and consistency
                  id="cuisine_type"
                  name="cuisine_type"
                  // Apply the handler to store the selected value
                  onChange={handleSelectChange}
            ...
            <div className="sm:col-span-2 sm:col-start-1 ">
              ...
              <div className="mt-2">
                ...
                >
                  ...
                  <option value={"Morning and After Noon"}>
                    {" "}
                    Morning and After Noon{" "}
                  </option>
                  <option value={"Morning and after Noon Evening"}>
                    Morning and after Noon Evening
                  </option>
                </select>
              </div>
            </div>
